        ...
        <div className="space-y-4 max-w-md mx-auto">
          ...
          >
            ...
            <div>
              ...
              <p className="text-gray-300">Newcastle upon Tyne, United Kingdom</p>
            </div>
          </motion.div>
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              <div className="p-2 bg-orange-500/10 rounded-full">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-orange-500">
                  <path d="M22 12a10.06 10.06 1 0 0-3.6-7.78C17.4 3.32 16.06 3 14.6 3h-1.2c-1.46 0-2.8.32-3.8.78A10.06 10.06 1 0 0 2 12a10.06 10.06 1 0 0 3.6 7.78c1 .46 2.34.78 3.8.78h1.2c1.46 0 2.8-.32 3.8-.78A10.06 10.06 1 0 0 22 12Z"></path>
                  <path d="M16 8v8"></path>
                  <path d="M8 11v5"></path>
                  <path d="m12 16 3-8 3 8"></path>
                </svg>
              </div>
            ...
            <div className="flex justify-center space-x-8">
              <motion.a 
                href="https://www.linkedin.com/in/han2873292a7/" 
                target="_blank" 
